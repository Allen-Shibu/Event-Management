        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <main className="max-w-[700px] mx-auto w-full px-6 py-10">
                ...
                <div className="flex items-center gap-2 text-sm mb-5">
                    <Link to="/dashboard" className="text-primary no-underline hover:underline">Dashboard</Link>
                ...
                <div className="mb-10">
                    ...
                    <p className="text-base text-gray-500">Bring your campus community together with a great activity.</p>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 mb-8 shadow-sm">
                    ...
                    <div className="flex items-center justify-between relative">
                        ...
                        {stepsData.map((step) => {
                            ...
                            return (
                                <div key={step.number} className="flex flex-col items-center gap-2.5 bg-white px-2">
                                    <div
                                        className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold transition-colors ${isActive
                                    ...
                                    <span className={`text-xs font-semibold tracking-wider ${isActive ? 'text-primary' : isPast ? 'text-slate-700' : 'text-gray-400'}`}>
                                        {step.label}
                                    </span>
                                </div>
                            )
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="w-6 h-6 rounded-full bg-primary/15 flex items-center justify-center">
                                        <svg width="10" height="10" viewBox="0 0 20 20" fill="#2B8CEE"><circle cx="10" cy="10" r="4" /></svg>
                                    </div>
                                ...
                                {/* Event Title */}
                                <div className="mb-6">
                                    <label className="block text-sm font-semibold text-slate-700 mb-2.5">Event Title</label>
                                    <input
                                        type="text"
                                    ...
                                    <div className="flex flex-wrap items-center gap-3">
                                        {categories.map((cat) => (
                                            <button
                                                ...
                                                className={`flex items-center gap-2.5 px-6 py-3 rounded-full text-sm font-medium cursor-pointer transition-all border ${activeCategory === cat.label
                                            ...
                                            >
                                                <div className={`flex items-center justify-center ${activeCategory === cat.label ? 'text-white' : 'text-slate-400'}`}>
                                                    {cat.icon}
                                                </div>
                                                {cat.label}
                                            </button>
                                ...
                                {/* Description */}
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-2.5">Description</label>
                                    <textarea
                                    ...
                                    />
                                    <p className="text-xs text-gray-400 mt-2">Maximum 2000 characters</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="w-6 h-6 rounded-lg bg-primary/15 flex items-center justify-center">
                                        <svg width="10" height="10" viewBox="0 0 20 20" fill="#2B8CEE"><rect x="2" y="2" width="16" height="16" rx="2" /></svg>
                                    </div>
                                    <h2 className="text-lg font-bold text-slate-900">Event Banner</h2>
                                </div>
                                ...
                                <div className="border-2 border-dashed border-gray-200 rounded-2xl py-14 px-8 flex flex-col items-center gap-4 hover:border-primary/40 transition-colors cursor-pointer bg-gray-50/50">
                                    ...
                                    <p className="text-xs text-gray-400 text-center">PNG, JPG or WEBP (Recommended 1600x900px, max 5MB)</p>
                                    <button type="button" className="mt-2 bg-white border border-gray-300 rounded-xl px-6 py-2.5 text-sm font-medium text-slate-700 hover:bg-gray-50 transition-colors cursor-pointer shadow-sm">
                                        Select File
                                    </button>
                                </div>
                            </div>
                    ...
                    {currentStep === 2 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
                            {/* Location */}
                            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
                                <h2 className="text-lg font-bold text-slate-900 mb-6">Where is it taking place?</h2>
                                ...
                                {locationType === 'Offline' ? (
                                    <>
                                        <div className="mb-5">
                                            <label className="block text-sm font-semibold text-slate-700 mb-2.5">Venue Name</label>
                                            <input type="text" placeholder="e.g. Main Auditorium" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-semibold text-slate-700 mb-2.5">Full Address</label>
                                            <textarea placeholder="Building, Room number, Street..." rows={2} className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 resize-y" />
                                        </div>
                                    </>
                                ) : (
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">Meeting Link</label>
                                        <input type="url" placeholder="https://zoom.us/j/..." className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                        <p className="text-xs text-gray-400 mt-2">Provide a Zoom, Google Meet, or Teams link.</p>
                                    </div>
                                )}
                            </div>
                            ...
                            {/* Date & Time */}
                            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
                                <h2 className="text-lg font-bold text-slate-900 mb-6">When is it happening?</h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">Start Date</label>
                                        <input type="date" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">Start Time</label>
                                        <input type="time" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">End Date</label>
                                        <input type="date" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">End Time</label>
                                        <input type="time" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                    </div>
                                </div>
                            </div>
                    ...
                    {currentStep === 3 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
                            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
                                <h2 className="text-lg font-bold text-slate-900 mb-6">Ticketing Options</h2>
                                ...
                                {ticketType === 'Paid' && (
                                    <div className="mb-6">
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">Ticket Price</label>
                                        <div className="relative">
                                            <span className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 font-semibold">$</span>
                                            <input type="number" placeholder="25.00" className="w-full border border-gray-200 rounded-xl py-3.5 pl-9 pr-5 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">Capacity Limit</label>
                                        <input type="number" placeholder="e.g. 150" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                        <p className="text-xs text-gray-400 mt-2">Leave empty for unlimited</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">Registration Deadline</label>
                                        <input type="datetime-local" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
                            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
                                ...
                                <div className="space-y-4 mb-8">
                                    {/* Public Card */}
                                    <label className={`flex items-start gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${visibility === 'Public' ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-primary/40'}`}>
                                        <div className="mt-0.5">
                                            <input type="radio" name="visibility" checked={visibility === 'Public'} onChange={() => setVisibility('Public')} className="w-4 h-4 text-primary" />
                                        </div>
                                        <div>
                                            <p className="font-bold text-slate-900 text-sm mb-1">Public</p>
                                            <p className="text-sm text-gray-500 leading-relaxed">Anyone can see and register for this event. It will be listed on the Explore page.</p>
                                        </div>
                                    </label>

                                    {/* Private Card */}
                                    <label className={`flex items-start gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${visibility === 'Private' ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-primary/40'}`}>
                                        <div className="mt-0.5">
                                            <input type="radio" name="visibility" checked={visibility === 'Private'} onChange={() => setVisibility('Private')} className="w-4 h-4 text-primary" />
                                        </div>
                                        <div>
                                            <p className="font-bold text-slate-900 text-sm mb-1">Private (Invite Only)</p>
                                            <p className="text-sm text-gray-500 leading-relaxed">Unlisted. Only people with the direct link can view and register.</p>
                                        </div>
                                    </label>
                                </div>

                                <div className="border-t border-gray-100 pt-8 mb-6">
                                    <h2 className="text-lg font-bold text-slate-900 mb-6">Tags & Contact Details</h2>
                                    <div className="mb-6">
                                        <label className="block text-sm font-semibold text-slate-700 mb-2.5">Tags</label>
                                        <input type="text" placeholder="e.g. Technology, Networking, AI (Comma separated)" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                    </div>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-sm font-semibold text-slate-700 mb-2.5">Contact Email</label>
                                            <input type="email" placeholder="organizer@university.edu" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-semibold text-slate-700 mb-2.5">Website (Optional)</label>
                                            <input type="url" placeholder="https://" className="w-full border border-gray-200 rounded-xl py-3.5 px-5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                                        </div>
                                    </div>
                                </div>
                            </div>
