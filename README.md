...
A college event discovery and management platform where students can find, attend, and organize campus events.

Live Site: https://openorbit-ten.vercel.app

## 📄 Pages
- [Sign Up](https://openorbit-ten.vercel.app/) — `/`
- [Login](https://openorbit-ten.vercel.app/login) — `/login`
